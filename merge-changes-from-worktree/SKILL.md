...
From the source worktree path, run the project checks that would normally run before a merge, such as tests, linters, or build commands.

If command fails, stop. Report the failing command and do not merge.
